...
internal data class RenderStateSnapshotStateful(
...
internal class GameRendererStateful(
    private val backgroundDrawer: BackgroundDrawer,
    private val tileDrawer: TileDrawer,
    private val entityDrawerStateful: EntityDrawerStateful
) {
    ...
    fun drawTransitionFrame(
        ...
        renderState: RenderStateSnapshotStateful,
    ...
    fun drawEntities(
        ...
        entityDrawerStateful.drawBoxes(canvas, viewport, renderState.boxPositions, renderState.selectedBox)
        if (drawPlayer) {
            entityDrawerStateful.drawPlayer(
                canvas = canvas,
                viewport = viewport,
    ...
    private fun drawTransitionEntities(
        ...
        for (position in renderState.boxPositions) {
            ...
            entityDrawerStateful.drawBoxes(
                canvas = canvas,
                viewport = viewport,
